...
export function useErrorMessageContext() {
	...
	if (!result) {
		// TODO this could be the case when app first loads. but why only with searchResults component? It happens when I search and fetch all data at the same time. Wait until I have CSS to see if it persists. => no
